...
//     // здесь мы отправляем имя и пароль получаем ответ и если такой пользователь существует, переходим дальше
//     const handleSubmit = () => {
//         console.log('Авторизация с данными:', username, password, rememberMe);
...
// import styles from './styles.module.css';
// import { Link, useNavigate } from 'react-router-dom';
// import { useAuthContext } from '../../helpers/authContext'; // Импортируем наш хук контекста
...
//         // Здесь должна быть реальная проверка аутентификации
...
//             login(username, username.slice(0, 2).toUpperCase());
